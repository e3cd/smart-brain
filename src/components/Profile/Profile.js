                ...
                <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
                    <main className="pa4 black-80 w-80">
                        ...
                        <div className="measure">
                            <label className="mt2 fw76" htmlFor="user-name">Name:</label>
                            <input
                            ...
                            />
                            <label className="mt2 fw76" htmlFor="user-name">Age:</label>
                            <input
                                className=" pa2  ba  w-100"
                                type="text"
                            ...
                            />
                            <label className="mt2 fw76" htmlFor="user-name">Pet:</label>
                            <input
                                className=" pa2  ba  w-100"
                                type="text"
